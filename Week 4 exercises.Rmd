...
```{r}
likelihood_step <- function(theta, x, x_next, deltat, params){
...
#We get a number, wwhich is promising
```
Now, we try to optimize this for some parameter vector theta.
```{r}
theta_0 <- c(100, 100, 100, 5, 10, 30)
optim(par = theta_0, fn = likelihood_total, process = x_coarse, deltat = 0.1)
```
